...
int month;
 ...
 // hours=zuhar;
  ...
  cout<<"*****************Zuhar prayer time is**********************"<<endl<<endl<<endl;
   ...
   cout<<"\t"<<"\t"<<"\t"<<hours<<":"<<minutes<<"pm"<<endl;
    ...
    cout<<"*****************maghrib prayer time is**********************"<<endl<<endl<<endl;
    cout<<"\t"<<"\t"<<"\t"<<hours<<":"<<minutes<<"pm"<<endl;
  ...
  I=acos((sin(AIT)-(sin(phi)*sin(declination_of_sun)))/(cos(phi)*(cos(declination_of_sun))));//0.534
   ...
   double CD=(I*57.295)/15;
    ...
    cout<<"*****************FAJAR prayer time is**********************"<<endl<<endl<<endl;
    ...
    H=(acos((sin(p)-(sin(phi)*sin(declination_of_sun))/(cos(phi)*cos(declination_of_sun)))))/15;
     ...
     cout<<"*****************ASAR prayer time is**********************"<<endl<<endl<<endl;
      cout<<"\t"<<"\t"<<"\t"<<hours<<":"<<minutes<<"pm"<<endl;
